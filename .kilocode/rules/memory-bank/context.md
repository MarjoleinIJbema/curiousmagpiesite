...
- [x] **Vaste verkooppunten sectie (2026-08-12)**: Added a "Vaste verkooppunten" section to `agenda/index.html` (between "Eerdere markten" and the CTA) listing physical stores that stock the ceramics permanently. Reuses the `.market-card` component (title + 📍 address, "Bekijk winkel" badge linking out). First store: Studio Boter, Oude Boteringestraat 5, 9712GA Groningen (https://www.studioboter.com/). Goal is to grow to 3 stores.
